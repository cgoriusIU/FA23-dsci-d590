...
Delia :
Chelsea : Wrote the boxplot compare function, wrote the description of the graphs in that section. Combined the python code into the .Rmd file and submitted the url
